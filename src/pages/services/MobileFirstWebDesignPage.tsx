  ...
  return (
    <>
      ...
      <div className="min-h-screen relative">
        {/* Hero Section - with background transparent for WebGL */}
        <section className="relative text-white py-20 z-10">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/80 via-purple-600/80 to-cyan-600/80"></div>
