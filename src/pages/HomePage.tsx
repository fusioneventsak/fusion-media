...
export default function HomePage() {
  ...
  return (
    <div ref={containerRef} className="relative pointer-events-none">
      ...
      {/* Keep original showcases for now until horizontal works properly */}
      <>
        <motion.div
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8 py-20">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg md:text-xl text-white opacity-70 leading-relaxed font-light mb-8">
                  Tailored internal tools and CRM systems built specifically for your organization's workflow. Streamline operations, improve efficiency, and gain valuable insights with applications designed around your unique business needs and processes.
                </p>
                <ul className="space-y-6">
                  {[
                    ...
                    <li key={index} className="flex items-start space-x-4">
                      ...
                      <span className="text-white opacity-90 font-medium leading-relaxed">{feature}</span>
                    </li>
                  ))}
                </ul>
              </div>
              <div className="relative">
                ...
                >
                  <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
                    <iframe
                      src="https://splendid-cannoli-324007.netlify.app/"
                  ...
                  <button
                    onClick={() => window.open('https://splendid-cannoli-324007.netlify.app/', '_blank')}
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8 py-20">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg md:text-xl text-white opacity-70 leading-relaxed font-light mb-8">
                  Real-time interaction tools that connect performers with their audience in meaningful ways. From song requests to live polling, these platforms create deeper engagement and memorable experiences for bands, DJs, and entertainers of all kinds.
                </p>
                <ul className="space-y-6">
                  {[
                    'Live song request systems for bands, DJs, and performers',
              ...
              <div className="relative">
                ...
                >
                  ...
                  <button
                    onClick={() => window.open('http://urequestsongs.com', '_blank')}
                    className="absolute bottom-4 right-4 px-4 py-2 bg-white/20 text-white rounded-full font-medium hover:bg-white/30 transition-all duration-300 backdrop-blur-sm"
                  >
                    Full Screen
                  </button>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8 py-20">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg md:text-xl text-white opacity-70 leading-relaxed font-light mb-8">
                  Gamified experiences and interactive elements that boost engagement on websites and at live events. From custom game shows to educational tools, we create interactive components that entertain, inform, and drive meaningful user participation.
                </p>
                <ul className="space-y-6">
                  {[
                    'Custom game shows, trivia platforms, and interactive competitions',
              ...
              <div className="relative">
                ...
                >
                  <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
                    <iframe
                      src="https://capable-alfajores-d0dff2.netlify.app/"
                      style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}
                      frameBorder="0"
                      allowFullScreen
                      loading="lazy"
                  ...
                  <button
                    onClick={() => window.open('https://capable-alfajores-d0dff2.netlify.app/', '_blank')}
                    className="absolute bottom-4 right-4 px-4 py-2 bg-white/20 text-white rounded-full font-medium hover:bg-white/30 transition-all duration-300 backdrop-blur-sm"
                  >
                    Full Screen
                  </button>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8 py-20">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg md:text-xl text-white opacity-70 leading-relaxed font-light mb-8">
                  Beautiful, high-performance websites that drive real business results. Built with modern HTML, CSS, and JavaScript, optimized for speed, SEO, and conversions. Perfect for service businesses, corporate brands, and growing organizations.
                </p>
                <ul className="space-y-6">
                  {[
                    'Modern, responsive design with mobile-first approach',
              ...
              <div className="relative">
                ...
                >
                  <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
                    <iframe
                      src="https://www.fusion-events.ca"
                      style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}
                      frameBorder="0"
                      allowFullScreen
                      loading="lazy"
                  ...
                  <button
                    onClick={() => window.open('https://www.fusion-events.ca', '_blank')}
                    className="absolute bottom-4 right-4 px-4 py-2 bg-white/20 text-white rounded-full font-medium hover:bg-white/30 transition-all duration-300 backdrop-blur-sm"
                  >
                    Full Screen
                  </button>
